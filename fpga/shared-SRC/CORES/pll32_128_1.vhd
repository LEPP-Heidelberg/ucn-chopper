...
-- Module  Version: 5.7
--C:\lscc\diamond\3.6_x64\ispfpga\bin\nt64\scuba.exe -w -n pll32_128_1 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 32 -fclkop 32 -fclkop_tol 0.0 -fclkos 128 -fclkos_tol 0.0 -fclkos2 1 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 

-- Thu Dec 17 13:50:31 2015
...
architecture Structure of pll32_128_1 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "128.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "32.000000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "32.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  3, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  15, 
        ...
        CLKOS_DIV=>  4, CLKOP_DIV=>  16, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll32_128_1 is
    for Structure
