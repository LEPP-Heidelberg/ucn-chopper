-- $Id: sed_check_xo4.vhd 1202 2026-06-17 05:50:35Z  $:
...
generic (
    Nbits         : Integer := 19;
    SED_CLK_FREQ  : string  := "33.25";
    --{015, 010, 015_256P, 025, 050, 050_400P, 080, 110}
    DEV_DENSITY   : string  := "025");
port(
    clk           : in  std_logic;
    rst           : in  std_logic;
    ...
    sed_time_s    : out std_logic_vector(Nbits-1 downto 0); -- measured in system clocks
    sed_cnt_s     : out std_logic_vector(Nbits-1 downto 0) ); -- cycles in the own clock
end sed_check;
...
signal sed_time          : std_logic_vector(sed_cnt'range);
