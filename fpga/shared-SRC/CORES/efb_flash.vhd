...
-- Module  Version: 1.2
--scuba -w -n efb_flash -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 20 -ufm -ufm_ebr 510 -mem_size 1 -ufm_0 -wb -dev 2000

-- Wed Jul 29 10:58:04 2015
-- $Id: efb_flash.vhd 1065 2024-03-16 06:40:18Z angelov $:
...
architecture Structure of efb_flash is
...
begin
    ...
    EFBInst_0: EFB
        ...
        EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> EFB_WB_CLK_FREQ)
