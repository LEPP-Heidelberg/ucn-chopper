...
-- Module  Version: 5.7
--C:\lscc\diamond\3.7_x64\ispfpga\bin\nt64\scuba.exe -w -n pll48to32 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 48 -fclkop 32 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 

-- Tue Oct 11 12:43:27 2016
...
architecture Structure of pll48to32 is
    ...
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "48.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  14, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  15, CLKFB_DIV=>  2, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll48to32 is
    for Structure
