...
-- Module  Version: 1.2
--D:\Lattice\Diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n efb_flash_i2c -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 50 -i2c1config -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -ufm -ufm_ebr 2045 -mem_size 1 -ufm_0 -wb -dev 7000

-- Tue Mar 12 12:53:51 2024
-- $Id: efb_flash_i2c.vhd 1065 2024-03-16 06:40:18Z angelov $:
...
architecture Structure of efb_flash_i2c is
...
begin
    ...
    EFBInst_0: EFB
        ...
        UFM_INIT_ALL_ZEROS=> "ENABLED", UFM_INIT_START_PAGE=>  UFM_INIT_START_PAGE,
        UFM_INIT_PAGES=>  1, DEV_DENSITY=> DEV_DENSITY, EFB_UFM=> "ENABLED",
        ...
        I2C1_GEN_CALL=> "DISABLED", I2C1_CLK_DIVIDER=>  32,
        I2C1_BUS_PERF=> "400kHz", I2C1_SLAVE_ADDR=> "0b1000001",
        I2C1_ADDRESSING=> "7BIT", EFB_I2C1=> "ENABLED", EFB_WB_CLK_FREQ=> EFB_WB_CLK_FREQ)
