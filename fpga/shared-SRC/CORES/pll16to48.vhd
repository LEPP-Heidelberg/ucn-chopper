...
-- Module  Version: 5.7
--C:\lscc\diamond\3.7_x64\ispfpga\bin\nt64\scuba.exe -w -n pll16to48 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 16 -fclkop 48 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 

-- Tue Apr 26 09:15:54 2016
...
architecture Structure of pll16to48 is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  11, CLKFB_DIV=>  3, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll16to48 is
    for Structure
