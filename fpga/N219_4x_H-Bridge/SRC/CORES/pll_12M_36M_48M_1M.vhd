...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_12M_36M_48M_1M -lang vhdl -synth synplify -arch se5c00 -type pll -fin 12 -fclkop 36 -fclkop_tol 0.0 -fclkos 48 -fclkos_tol 0.0 -fclkos2 1 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 

-- Thu Aug 06 14:31:38 2026
...
entity pll_12M_36M_48M_1M is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        CLKOS: out  std_logic; 
        CLKOS2: out  std_logic);
end pll_12M_36M_48M_1M;

architecture Structure of pll_12M_36M_48M_1M is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "1.000000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "48.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "36.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  35, CLKOS_FPHASE=>  0, 
        CLKOS_CPHASE=>  11, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  15, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  36, 
        CLKOS_DIV=>  12, CLKOP_DIV=>  16, CLKFB_DIV=>  3, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of pll_12M_36M_48M_1M is
    for Structure
