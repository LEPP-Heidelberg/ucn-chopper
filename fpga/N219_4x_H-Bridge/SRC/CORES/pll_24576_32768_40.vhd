...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24576_32768_40 -lang vhdl -synth synplify -arch se5c00 -type pll -fin 24.576 -fclkop 32.768 -fclkop_tol 0.0 -fclkos 40 -fclkos_tol 0.2 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 

-- Wed Jul 29 13:47:40 2026
...
entity pll_24576_32768_40 is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        CLKOS: out  std_logic);
end pll_24576_32768_40;

architecture Structure of pll_24576_32768_40 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "40.049778";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  8, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  10, 
        ...
        CLKOS_DIV=>  9, CLKOP_DIV=>  11, CLKFB_DIV=>  4, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of pll_24576_32768_40 is
    for Structure
