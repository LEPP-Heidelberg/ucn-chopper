...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24k_32k_48k_ts -lang vhdl -synth synplify -arch se5c00 -type pll -fin 24.576 -fclkop 32.768 -fclkop_tol 0.0 -fclkos 49.152 -fclkos_tol 0.0 -fclkos2 1 -fclkos2_tol 5.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 

-- Fri Jul 31 07:39:39 2026
...
entity pll_24k_32k_48k_ts is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        CLKOS: out  std_logic; 
        CLKOS2: out  std_logic);
end pll_24k_32k_48k_ts;

architecture Structure of pll_24k_32k_48k_ts is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "1.024000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "49.152000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "32.768000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "24.576000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  31, CLKOS_FPHASE=>  0, 
        CLKOS_CPHASE=>  9, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  14, 
        ...
        OUTDIVIDER_MUXC2=> "DIVC", PREDIVIDER_MUXC1=>  1, VCO_BYPASS_C0=> "DISABLED", 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  32, 
        CLKOS_DIV=>  10, CLKOP_DIV=>  15, CLKFB_DIV=>  4, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of pll_24k_32k_48k_ts is
    for Structure
        for all:VLO use entity MachXO3D.VLO(V); end for;
        for all:EHXPLLJ use entity MachXO3D.EHXPLLJ(V); end for;
    end for;
end Structure_CON;
