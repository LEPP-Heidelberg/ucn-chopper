...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24k_32k_64k -lang vhdl -synth synplify -arch se5c00 -type pll -fin 24.576 -fclkop 32.768 -fclkop_tol 0.0 -fclkos 65.536 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 

-- Wed Jul 29 14:20:01 2026
...
architecture Structure of pll_24k_32k_64k is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "65.536000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  7, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  15, 
        ...
        CLKOS_DIV=>  8, CLKOP_DIV=>  16, CLKFB_DIV=>  4, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of pll_24k_32k_64k is
    for Structure
